  ...
  const generateSeedData = async () => {
    ...
    try {
      ...
      const faculty1 = await facultyApi.create({
        ...
        teachingSubjects: ['Data Structures', 'Algorithms'],
      ...
      const faculty2 = await facultyApi.create({
        ...
        teachingSubjects: ['Web Development', 'Networking'],
        researchInterests: ['Web Security', 'Network Protocols'],
        publications: 8,
        achievements: ['Best Paper Award 2024'],
        course: 'B.E',
        academicYear: '2024-25',
      });
